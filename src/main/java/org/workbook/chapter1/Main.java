...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Map<Character, Integer> duplicatesV1 = StringUtils.countDuplicateCharactersV1(TEXT);
        ...
        Map<Character, Long> duplicatesV2 = StringUtils.countDuplicateCharactersV2(TEXT);
        ...
        Map<String, Integer> duplicatesV3 = StringUtils.countDuplicateCharactersVCP1(TEXT_CP);
        ...
        Map<String, Long> duplicatesV4 = StringUtils.countDuplicateCharactersVCP2(TEXT_CP);
